...
public class ZCatmullRom {
    ...
    public ZCatmullRom(List<WB_Point> controlPoints, int samplesPerSpan, boolean closed) {
    ...
    public ZCatmullRom(Coordinate[] controlPoints, int samplesPerSpan, boolean closed) {
        ...
        for (Coordinate c : controlPoints) {
            curveControlPts.add(new WB_Point(c.getX(),c.getY()));
        }
        this.curveDividePts = calculateCatmull(curveControlPts);
    }
     ...
     */
    private List<WB_Point> extendCtrlPointsSet(List<? extends WB_Point> points) {
